...
def run():
    ...
    print(f"Starting gradient descent at b = {initial_b}, w = {initial_w}, "
          f"error = {compute_error_for_line_given_points(initial_b, initial_w, points)} ")
    print("Running... ")
    [w, b] = gradient_descent_runner(points, initial_b, initial_w, learning_rate, num_iterations)
    print(f"After {num_iterations},b ={b}, w ={w}, error = {compute_error_for_line_given_points(b, w, points)}")
